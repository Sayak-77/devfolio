...
const WORDS = ["MERN Stack Developer", "Flutter Enthusiast","WordPress Developer"];
const TECH_STACK = ["React", "Java", "Node", "Postgresql"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Sayak-77" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/sayak-chatterjee-2237581b9" },
  { icon: Instagram, link: "https://www.instagram.com/ku.rama.__/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  _creed .code .crack. <br/>
                  Passionate about building user-friendly websites and always ready to innovate with modern, efficient solutions
                </p>
